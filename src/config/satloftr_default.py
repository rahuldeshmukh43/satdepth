...
_CN.LOFTR.RESOLUTION = (8, 2) #(8, 2)  # options: [(8, 2), (16, 4)]
_CN.LOFTR.FINE_WINDOW_SIZE = 5  # window_size in fine_level, must be odd
_CN.LOFTR.FINE_CONCAT_COARSE_FEAT = True
_CN.LOFTR.GT_MATCHES_3D_DISTANCE_THR = 1.0 # (meters) euclidean distance threshold on lat, lon, ht to declare a match

# 1. LoFTR-backbone (local feature CNN) config
_CN.LOFTR.RESNETFPN = CN()
_CN.LOFTR.RESNETFPN.INITIAL_DIM = 128
_CN.LOFTR.RESNETFPN.BLOCK_DIMS = [128, 196, 256]  # s1, s2, s3 8_2
# _CN.LOFTR.RESNETFPN.BLOCK_DIMS = [128, 128, 196, 256]  # s1, s2, s3, s4 16_4
